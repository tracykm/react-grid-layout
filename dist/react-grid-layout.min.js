!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      function l(t, e, n) {
        for (
          var r = g(t), o = S(t, e), a = Array(t.length), i = 0, s = o.length;
          i < s;
          i++
        ) {
          var u = o[i];
          u.static || ((u = f(r, u, e, n, o)), r.push(u)),
            (a[t.indexOf(o[i])] = u),
            (u.moved = !1);
        }
        return a;
      ...
      (function(t, n) {
        ...
        function Y(t, e, n, r, o, a) {
          ...
          if (p && !c)
            return (
              a || (a = new P()),
              i || Ae(t) ? V(t, e, n, r, o, a) : J(t, e, u, n, r, o, a)
            );
          if (!(n & bt)) {
          ...
          return !!p && (a || (a = new P()), $(t, e, n, r, o, a));
        }
        function q(t) {
        ...
        (qt["[object Float32Array]"] = qt["[object Float64Array]"] = qt[
          ...
          (qt[St] = qt[_t] = qt[It] = qt[Rt] = qt[Bt] = qt[Dt] = qt[jt] = qt[
            Et
          ] = qt[zt] = qt[Ct] = qt[kt] = qt[Lt] = qt[Nt] = qt[At] = qt[
            "[object WeakMap]"
          ] = !1);
        var Xt = "object" == typeof t && t && t.Object === Object && t,
          ...
          Jt = "object" == typeof e && e && !e.nodeType && e,
          $t = Jt && "object" == typeof n && n && !n.nodeType && n,
          Kt = $t && $t.exports === Jt,
          Qt = Kt && Xt.process,
          Zt = (function() {
            try {
    ...
    function(t, e, n) {
          ...
          return (
            ...
            (e.prototype.componentDidMount = function() {
              ...
              (this.props.dragApiRef.value = {
                dragIn: function(n) {
                  ...
                  var l = t.props,
                    c = l.margin,
                    f = l.containerPadding,
                    p = (0, m.calcXY)(u.top, u.left, {
                  ...
                  if (t.state.activeDrag)
                    t.onDrag(r, d, h, { e: s, node: i, newPosition: u });
                  else {
                    var y = { i: r, w: o, h: a, x: d, y: h },
                      v = JSON.parse(JSON.stringify(t.state.layout)),
                      b = [].concat(t.state.layout),
                      w = (0, g.getLayoutItem)(b, r);
                    if (w) {
                      b = (0, g.moveElement)(
                        b,
                        w,
                        ...
                        h,
                        !0,
                        t.props.preventCollision,
                        t.compactType(),
                        t.props.cols
                      );
                    } else b = [].concat(t.state.layout, [y]);
                    t.setState({
                      oldDragItem: y,
                      oldLayout: v,
                      layout: b,
                      ...
                      t.props.onDragStart(b, y, y, null, s, i);
                  }
                },
                dragOut: function(n) {
                  n.event;
                  if (e) {
                    var r = e,
                      o = r.i,
                      a = (0, g.compact)(
                        t.state.layout.filter(function(t) {
                          return t.i !== o;
                        }),
                        t.compactType(),
                        t.props.cols
                    ...
                    t.setState(function() {
                      return { layout: a, activeDrag: null };
                    }),
                      t.onLayoutMaybeChanged(a, t.state.oldLayout);
                  }
                },
                stop: function(n) {
                  var r = n.event,
                  ...
                  if (e) {
                    var a = e,
                      ...
                      c = t.props,
                      f = c.margin,
                      p = c.containerPadding,
                      d = (0, m.calcXY)(o.top, o.left, {
                        containerWidth: t.props.width,
                        cols: t.props.cols,
                        margin: f,
                        containerPadding: p || f,
                        rowHeight: t.props.rowHeight,
                        maxRows: t.props.maxRows,
                        w: s,
                        h: u
                      ...
                      h = d.x,
                      y = d.y;
                    t.onDragStop(i, h, y, { e: r, node: l, newPosition: o }),
                      (e = null);
                  }
                }
              }),
            ...
            (e.prototype.render = function() {
              var t = this,
                ...
                n = e.className,
                r = e.style,
                o = s({ height: this.containerHeight() }, r);
              return l.default.createElement(
                "div",
                { className: (0, y.default)("react-grid-layout", n), style: o },
      ...
      (b.displayName = "ReactGridLayout"),
        ...
        (b.defaultProps = {
          ...
          preventCollision: !1,
          dragApiRef: (0, g.createDragApiRef)(),
...
*/
    ...
    function(t, e, n) {
      ...
      function u(t, e, n) {
        ...
        return (
          (f = Math.max(Math.min(f, o - i), 0)),
          (p = Math.max(Math.min(p, l - u), 0)),
          { x: f, y: p }
        );
      }
      e.__esModule = !0;
          ...
          return (
            ...
            (e.prototype.calcPosition = function(t, e, n, r, o) {
              var a = this.props,
                ...
                c = s(this.props),
                f = {
                  left: Math.round((c + i[0]) * t + u[0]),
                  top: Math.round((l + i[1]) * e + u[1]),
                  width:
                    n === 1 / 0
                      ? n
                  ...
                  height:
                    r === 1 / 0
                      ? r
                      : Math.round(l * r + Math.max(0, r - 1) * i[1])
                };
              return (
                o &&
                  o.resizing &&
            ...
            (e.prototype.createStyle = function(t) {
              ...
              return (
                o
                  ? (a = (0, g.setTransform)(t))
                  : ((a = (0, g.setTopLeft)(t)),
                    n &&
                      ((a.left = (0, g.perc)(t.left / r)),
                      (a.width = (0, g.perc)(t.width / r)))),
                a
              );
            }),
            ...
            (e.prototype.mixinResizable = function(t, e) {
              var n = this.props,
                ...
                s = n.maxW,
                u = n.maxH,
                l = this.calcPosition(0, 0, r - o, 0).width,
                c = this.calcPosition(0, 0, a, i),
                p = this.calcPosition(0, 0, s, u),
                d = [c.width, c.height],
                h = [Math.min(p.width, l), Math.min(p.height, 1 / 0)];
              return f.default.createElement(
                y.Resizable,
                {
                  width: e.width,
                ...
                if (s) {
                  ...
                  switch (t) {
                    case "onDragStart":
                      ...
                      (l.left = p.left - f.left + c.scrollLeft),
                        (l.top = p.top - f.top + c.scrollTop),
                        e.setState({ dragging: l });
                      break;
                    case "onDrag":
                      if (!e.state.dragging)
                        throw new Error("onDrag called before onDragStart.");
                      (l.left = e.state.dragging.left + a),
                        (l.top = e.state.dragging.top + i),
                        e.setState({ dragging: l });
                      break;
                    case "onDragStop":
                      if (!e.state.dragging)
                  ...
                  var d = u(l.top, l.left, e.props),
                    h = d.x,
                    y = d.y;
                  s.call(e, e.props.i, h, y, { e: n, node: o, newPosition: l });
                }
              };
            }),
            ...
            (e.prototype.render = function() {
              var t = this.props,
                ...
                c = f.default.Children.only(this.props.children),
                p = f.default.cloneElement(c, {
      ...
      (b.propTypes = {
        ...
        cols: d.default.number.isRequired,
        containerWidth: d.default.number.isRequired,
        rowHeight: d.default.number.isRequired,
        margin: d.default.array.isRequired,
        maxRows: d.default.number.isRequired,
        containerPadding: d.default.array.isRequired,
        x: d.default.number.isRequired,
        y: d.default.number.isRequired,
        w: d.default.number.isRequired,
        h: d.default.number.isRequired,
        minW: function(t, e) {
          var n = t[e];
        ...
        i: d.default.string.isRequired,
        onDragStop: d.default.func,
        ...
        isDraggable: d.default.bool.isRequired,
        isResizable: d.default.bool.isRequired,
        static: d.default.bool,
        useCSSTransforms: d.default.bool.isRequired,
          ...
          return (
            ...
            (e.prototype.onWidthChange = function(t) {
              ...
              if (
                ...
                i in u || (u[i] = (0, y.cloneLayout)(this.state.layout));
                var l = (0, g.findOrGenerateResponsiveLayout)(u, e, a, i, s, o);
                (l = (0, y.synchronizeLayoutWithChildren)(l, t.children, s, o)),
                  (u[a] = l),
                  this.props.onLayoutChange(l, u, this.state.breakpoint),
                  this.props.onBreakpointChange(a, s),
                  this.setState({ breakpoint: a, layout: l, cols: s });
              }
                ...
                (r.onWindowResize = function() {
                  if (r.mounted) {
                    ...
                    t instanceof HTMLElement &&
                      (t.offsetWidth ||
                        t.children.length ||
                        t.classList.contains("react-grid-layout")) &&
