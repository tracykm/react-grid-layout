          ...
          return (
            ...
            (e.prototype.onWidthChange = function(t) {
              ...
              if (
                ...
                i in l || (l[i] = (0, y.cloneLayout)(this.state.layout));
                var c = (0, g.findOrGenerateResponsiveLayout)(l, e, a, i, s, o);
                (c = (0, y.synchronizeLayoutWithChildren)(c, t.children, s, o)),
                  (l[a] = c),
                  this.props.onLayoutChange(c, l),
                  this.props.onBreakpointChange(a, s),
                  this.setState({ breakpoint: a, layout: c, cols: s });
              }
